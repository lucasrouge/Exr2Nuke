...
def create_setup():
    ...
    try :
        light_node_name = bpy.data.scenes["Scene"].node_tree.nodes["Light_exr"].base_path
    except:
        light_node_name = '//Render/Light/{}'.format(file_name) + '_###.exr' #mettre le path du projet

    try :
        data_node_name = bpy.data.scenes["Scene"].node_tree.nodes["Data_exr"].base_path
    except:
        data_node_name = '//Render/Data/{}'.format(file_name) + '_###.exr' #mettre le path du projet
...
#File Outputs
    ...
    FO_Light_node.base_path = light_node_name
    ...
    FO_Data_node.base_path = data_node_name
